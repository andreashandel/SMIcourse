...
We use the materials on this website as part of our annual course _Infectious Diseases, Immunology and Within-Host Models_ which is part of the [Summer Institute in Statistics and Modeling in Infectious Diseases (SISMID)](https://si.biostat.washington.edu/suminst/sismid). We also use the materials for other workshops we occasionally teach in this topic. 
...
The __General Information__ section provides a very brief overview.

The __Modules__ section and subsection contains the bulk of the content. Each module covers a specific topic and generally has several units in a drop-down/pop-out menu. 
Those units consist of a mix of videos, write-ups and exercises. It is generally recommended to go through them in the listed order.
