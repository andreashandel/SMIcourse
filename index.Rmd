...
description: |
  An online course covering the use of simulation modeling in immunology.
...
knitr::include_graphics("media/smi_logo.png")
```

<!-- Some trickery to get the logo to show. Seems to not work with distill. 
