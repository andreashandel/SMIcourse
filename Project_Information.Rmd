...
# Project Logistics
Since this is completely optional, it's really up to you how to structure your project. You can just play around, or you can try to write a formal report/paper. Given the shortness of time, it might be tricky to try and form teams with others and do a project as a group. But but you are certainly welcome to try and do so. You can use the _courseproject_ Slack channel to see if you can find others to team up with.
