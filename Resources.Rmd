...
* [Simulation Modelling for Immunologists](https://doi.org/10.1038/s41577-019-0235-3). A review/introduction we wrote on the topic. You will see a lot of overlap between that paper and the SMI materials. 
...
* [A software package for immunologists to learn simulation modeling](https://doi.org/10.1186/s12865-019-0321-0). This is a paper we wrote describing the [DSAIRM package](https://ahgroup.github.io/DSAIRM/). It's not as detailed as the documentation you can find on the DSAIRM package website, but includes some general thoughts on the motivation for the package.
