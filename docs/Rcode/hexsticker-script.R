...
img <- here('media',"SMIfigure.png")
sticker(img, package="SMI Course", p_size=20, p_y = 1.3, s_x=1, s_y=.85, s_width=0.8, s_height=0.8, filename=here('media',"SMIlogo.png"), h_fill = "#003ffd30", h_color = "#0cc789ff")
