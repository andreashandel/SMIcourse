...
<div style="float: left; width: 50%;">
```{r nrivirus2,  out.width = '100%', echo=FALSE, fig.align='center'}
knitr::include_graphics("../media/nri_review_fig2a.png")
```
</div>

<div style="float: right; width: 50%;">
```{r nrivirus3,  out.width = '100%', echo=FALSE, fig.align='center'}
knitr::include_graphics("../media/nri_review_fig2b.png")
```
</div>
