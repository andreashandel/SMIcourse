...
```{r phenomodel1,  fig.cap="Wu et al 2019 Nature Communications.", echo=FALSE, out.width = '60%', fig.align='center'}
...
```{r predictexample2,  fig.cap='Handel & Antia 2009 J Vir', echo=FALSE, out.width = '80%', fig.align='center'}
...
```{r kirschnertb,  echo=FALSE, fig.cap='', out.width = '50%', fig.align='center'}
