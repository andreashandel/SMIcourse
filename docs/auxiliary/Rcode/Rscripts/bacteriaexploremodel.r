...
plot(rvec,Bpeak,log="xy",pch=20,col="blue",xlab="",ylab="")


mtext("IR Activation Rate",side=1,line=2.5) #x-axis - change line to move in/out
mtext("Bacteria Peak",side=2,line=2) #y-axis

dev.print(device=png,width=ww,height=wh,units="in",res=600,file="../figures/exploreexample.png")
