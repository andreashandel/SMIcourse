...
For this module, the idea is to explore several models to get further understanding of the way model inputs affect outcomes.
...
Explore the models listed in the __What influences model results__ section of DSAIRM. Go through all the tabs at the bottom of each app. __The Model__ and __What to do__ are the most important sections. If you are completely new to these kinds of models, work through all the listed tasks to get an idea of how these models work.
